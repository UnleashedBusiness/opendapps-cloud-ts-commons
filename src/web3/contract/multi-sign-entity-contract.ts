...
import {MultiSignEntityAbi} from "@unleashed-business/opendapps-cloud-ts-abi";
import {
...
export class MultiSignEntityContract extends DecentralizedEntityInterfaceContract {
